...
namespace DataAdapters {
    ...
    public class dsCoustomers : DataSet {
        ...
        protected dsCoustomers(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsCoustomers cln = ((dsCoustomers)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsCoustomers";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsCoustomers.xsd";
